...
async def add_review(user_id: int, book_id: int, rating: float, comment: str):
    add = create_review_db(user_id=user_id, book_id=book_id, rating=rating, comment=comment)
    return add
