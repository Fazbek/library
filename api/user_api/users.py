...
async def add_user(username: str, email: str, password: str, phone_number: int):
    add = create_user_db(username=username, email=email, password=password, phone_number=phone_number)
    return add
